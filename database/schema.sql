...
SELECT 
    ...
    AVG(CAST(r.rating_value AS INTEGER)) as average_rating,
...
SELECT 
    ...
    AVG(CAST(r.rating_value AS INTEGER)) as average_rating_given
FROM users u
...
BEGIN
    ...
    SELECT 
        ...
        ROUND(AVG(CAST(r.rating_value AS INTEGER)), 2) as average_rating,
        json_build_object(
